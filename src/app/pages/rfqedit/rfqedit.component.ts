...
export class RFQEditComponent implements OnInit {
  orders = [];
  constructor(private messageService: MessageService,private formBuilder: FormBuilder,public constants: constants,private route: ActivatedRoute,public RfqService: RfqService,private router: Router) { }
 ...
 //this.loaddocDetailsbyitemsid();
  this.loaddocDetails();
    ...
    // }
    IGSTEnablefromCGST(){
      if (this.AddQuotation.controls['CGSTPercentage'].value != "" ||this.AddQuotation.controls['CGSTPercentage'].value !=null)
      {
...
this.rfqItemInfo.DeliveryDate=quoteDetail["ValidTo"];
