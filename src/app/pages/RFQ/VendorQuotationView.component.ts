...
export class VendorQuotationViewComponent implements OnInit {
  ...
  constructor(private messageService: MessageService, private formBuilder: FormBuilder, private spinner: NgxSpinnerService, public RfqService: RfqService, public constants: constants, private route: ActivatedRoute, private router: Router) { }
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(params => {
      if (params["RFQRevisionId"] != 0) {
        this.encrytedrfqid = this.constants.decrypt(params["RFQRevisionId"]);
        this.RfqRevisionId = this.encrytedrfqid;
